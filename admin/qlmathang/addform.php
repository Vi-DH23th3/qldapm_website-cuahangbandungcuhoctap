...
<div class="mb-3 mt-3">
	<label for="optdanhmuc" class="form-label">Danh mục hàng</label>
...
<div class="mb-3 mt-3">
    <label for="optnhacungcap" class="form-label">Nhà cung cấp</label>
    <select class="form-select" name="optnhacungcap">
